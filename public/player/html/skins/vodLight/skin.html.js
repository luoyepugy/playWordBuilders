	...
	'<div class="sewise-player-ui">' + 
		'<div class="controlbar">' + 
			...
			'<ul class="controlbar-btns">' + 
				...
				'<li class="right-float"><a href="javascript:;" class="controlbar-btns-soundclose" tabindex="1">音量</a></li>' + 
				'<li class="right-float"><a href="javascript:;" class="controlbar-btns-soundopen" tabindex="1">音量</a></li>' + 
		...
		'</div>' + 
		'<div class="logo">' + 
			'<a href="javascript:void(0)"  class="logo-icon" tabindex="1">logo</a>' + 
		'</div>' + 
		'<div class="topbar">' + 
