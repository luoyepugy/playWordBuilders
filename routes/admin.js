...
module.exports = function(router,app){
    ...
    // router.use(session({secret:"test"}));
    //router.use(function(req,res,next){
    //
    //    if(!session.user){
    ...
    router.get('/status', function(req, res, next) {
        ...
        async.parallel({
            ...
            //     });
            // },
            // weekNewVisitorsList:function(callback){
            //     statistics.getWeekNewVisitors(function(a){
            //         callback(null,a);
            //     });
            // },
            // monthNewVisitorsList:function(callback){
            //     statistics.getMonthNewVisitors(function(a){
            //         callback(null,a);
            //     });
            // },
            //
            // pie_data:function(callback){
            // statistics.getPieData(function(a){
            //     callback(null,a);
            // });
        //},
    ...
    router.get('/system', function(req, res, next) {
        ...
        async.parallel({
            ...
            //     db.collection('user').find({"name":req.session.user.username}).toArray(function(err,ret){
        ...
        //    res.render('admin/system-set', { users: ret,user:req.session.user });
        //})
    ...
    router.post('/system/seo',function(req,res){
        // db.collection('settings').update({},req.body,function(err,data){
        //     if(err)console.log(err);
        //     res.send('success');
        // })
    ...
    router.get('/sources/:tid/:cid',function(req,res){
        ...
        switch ( req.params.tid*1){
            case 1:
                dbName='images';
                //db.collection(dbName).find({dir:{$regex:req.params.cid}}).toArray(function(err,ret){
                //    if(err)console.log(err);
                //    console.log(ret);
    ...
    router.get('/upload/', function(req, res) {
        ...
        res.render('admin/uploadtest');
        //var FFMPEG =require('../lib/ffmpeg-util.js');
        //var executor = new FFMPEG();
        //console.log('---');
        //executor.execute('public/uploads/videos/2.flv','public/uploads/videos/2.mp4');


        //截图模块
        // var b;
        // var a=require('../lib/ffmpeg-util-screenshot.js');
        // a().screenshot('public/uploads/videos/upload_afa384139727b1a637020f8f0f00fe72.mp4','public/uploads/images/upload_afa384139727b1a637020f8f0f00fe72.jpg',function(a,c){b=c;console.log(b);})

        //剪切模块
        // var b;
        // var a=require('../lib/ffmpeg-util-cut.js');
        // a().cut('public/uploads/videos/2.mp4','public/uploads/videos/4.mp4',10,5,'public/uploads/videos/test.jpg',function(c){b=c;console.log(b)});
    ...
    router.post('/upload/:type', function(req, res) {
        ...
        // var F_ENCODE=require('../lib/ffmpeg-util.js');
        ...
        form.parse(req, function(err, fields, files) {
            ...
            .on('end', function() {
                ...
                if(req.params.type=='videos'){
                    ...
                    // var arr=fileData.path.split('\\');
                    // var name=arr[arr.length-1];
                    // var arr1=fileData.name.split('.');
...
//console.log(req.body);
        ...
        //var picoutput='public/uploads/images/'+req.body.name.slice(0,-3)+'jpg'
    ...
    router.get('/webstatus-set/:status',function(req,res){
        ...
        var collection=db.collection('settings');
        // collection.findOne({key:'index_config'},function(err,ret){
        //     if(err)console.log(err);
        //     // console.log("888888888888888888888888888888");
        //     // console.log(ret);
        //     ret.webstatus==req.params.status;
        //     console.log("888888888888888888888888888888");
        //     console.log(ret);
    ...
    router.get('/download/',function(req,res){
       ...
       // db.collection(req.params.type).findOne({url})
